<div class="min-h-screen grid grid-rows-[1fr,auto]">
    <div class="grid grid-cols-1 p-6 bg-gray-800">
        <div class="place-self-center md:w-1/3 lg:w-1/3">
            <div class="space-y-6">
                <div class="">
                    <p class=" tracking-tight text-xl font-bold text-white">&#9728; Always
                    Oil & Gas
                    </p>
                </div>
                ...
                <form wire:submit.prevent="login">
                    <div class="p-10 border border-gray-400 rounded-box space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="badge text-xs">Director Dashboard</div>
                        </div>
                ...
                <p class="text-2xs text-white">Powered by <a href="#" class="font-bold underline">Anoze.co</a></p>
            </div>
        </div>
    </div>
</div>
