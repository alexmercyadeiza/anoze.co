<div class="border-r border-gray-300 hidden lg:block sticky top-0 h-screen">
    ...
    <div class="p-8 space-y-4">
        ...
        <a href="/payments" class="font-medium uppercase tracking-widest">
            <div
                class="{{ Request::is('payments') || Request::is('record/sales') ? 'bg-yellow-400' : '' }} p-3 flex items-center justify-between cursor-pointer rounded-md hover:bg-yellow-300 focus:bg-yellow-100">
                <span> Sales </span>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                        d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z"
    ...
    <div class="p-8">
        <div class="text-2xs"><span class="font-bold">Manager ID:</span> ALWYS-12ER</div>
    </div>
</div>
